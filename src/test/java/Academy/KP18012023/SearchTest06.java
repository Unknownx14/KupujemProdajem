...
public class SearchTest06 extends BaseTest02 {

	
	
	@Test(dataProvider="getData", groups={"Search"})
	public void searcProduct(String wantedProductDP, String wantedCategoryDP) throws InterruptedException, IOException
	{
		...
		lppo.searchProduct(wantedProductDP);

		//String wantedCategory = "Mobilni telefoni";
		
		lppo.selectWantedSuggestion(wantedCategoryDP);
		...
		Assert.assertEquals(one, wantedCategoryDP);
		Assert.assertEquals(two, wantedProductDP);
